...
var patch = (0, _snabbdom.init)([]); // h 函数如果是两个参数时：1、标签 + 选择器；2、如果是字符串的话，就是设置标签的内容

var vnode = (0, _snabbdom.h)('div#container.cls', 'hello world');
var app = document.querySelector('#app'); // 参数是两个 vnode,对比 vonode
...
patch(oldVnode, vnode); // 2、div中放置元素 h1、p
