...
var vnode = (0, _snabbdom.h)('div#container', [(0, _snabbdom.h)('h1', 'hello snabbdom'), (0, _snabbdom.h)('p', '这是一个p标签')]);
var app = document.querySelector('#app');
var oldVnode = patch(app, vnode);
setTimeout(function () {
  vnode = (0, _snabbdom.h)('div#container', [(0, _snabbdom.h)('h1', 'hello world'), (0, _snabbdom.h)('p', 'hello p')]); // 对比两次节点的差异，更新到dom上

  patch(oldVnode, vnode); // 清空页面元素——创建注释节点来清空页面元素
  // 通过 h 函数创建注释节点
